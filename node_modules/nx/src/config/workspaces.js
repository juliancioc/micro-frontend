...
function workspaceConfigName(root, opts) {
    if ((0, fs_1.existsSync)(path.join(root, 'angular.json')) &&
        ...
        ((opts === null || opts === void 0 ? void 0 : opts._includeProjectsFromAngularJson) ||
...
class Workspaces {
    ...
    readProjectsConfig(opts) {
        ...
        if (workspaceFile) {
            workspace.projects = this.mergeWorkspaceJsonAndGlobProjects(this.readFromWorkspaceJson(opts).projects, workspace.projects);
        }
    ...
    readFromWorkspaceJson(opts) {
        const rawWorkspace = (0, fileutils_1.readJsonFile)(path.join(this.root, workspaceConfigName(this.root, opts)));
